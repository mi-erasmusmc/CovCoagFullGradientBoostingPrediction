...
The setup script below is used to install the **CovCoagFullGradientBoostingPrediction** package. You will need to modify this setup script as follows:
                                                                                              
- Set the `projectRootFolder` variable to the directory specific to your environment. In this example we are using `C:/CovCoagFullGradientBoostingPrediction`. This root folder will serve a few purposes:
...
projectFolder <- "C:/CovCoagFullGradientBoostingPrediction"
...
download.file("https://raw.githubusercontent.com/ohdsi-studies/CovCoagFullGradientBoostingPrediction/master/renv.lock", "renv.lock")
...
# finally install the CovCoagFullGradientBoostingPrediction package
install.packages('devtools')
devtools::install_github('ohdsi-studies/CovCoagFullGradientBoostingPrediction')

library(CovCoagFullGradientBoostingPrediction)
````                                                                                                 
# -------------------------------------------------------------
# What to expect
# -------------------------------------------------------------
...
You can safely continue by pressing 'y' after this prompt since the renv.lock file is downloaded from the **CovCoagFullGradientBoostingPrediction** GitHub code repository. Once the installation is complete, you may need to restart R (if you are working outside of RStudio) and you should see this message:

````
Project 'C:/CovCoagFullGradientBoostingPrediction' loaded. [renv 0.x.y]
````
