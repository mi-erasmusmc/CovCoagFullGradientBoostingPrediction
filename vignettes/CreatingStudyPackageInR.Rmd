...
- Install the dependencies for the skeleton (source the file at: [https://github.com/OHDSI/CovCoagFullGradientBoostingPrediction/blob/master/extras/packageDeps.R](https://github.com/OHDSI/CovCoagFullGradientBoostingPrediction/blob/master/extras/packageDeps.R) )
...
For the json creation you will need to source the code found at: https://github.com/OHDSI/CovCoagFullGradientBoostingPrediction/blob/master/extras/createPredSkelJson.R to load the function 'createDevelopmentStudyJson'. 
