...
#
# This file is part of CovCoagFullGradientBoostingPrediction
#
...
OhdsiRTools::checkUsagePackage("CovCoagFullGradientBoostingPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CovCoagFullGradientBoostingPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovCoagFullGradientBoostingPrediction.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "CovCoagFullGradientBoostingPrediction")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CovCoagFullGradientBoostingPrediction")
