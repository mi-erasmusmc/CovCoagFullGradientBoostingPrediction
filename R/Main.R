...
#'
#' @details
#' This function executes the CovCoagFullGradientBoostingPrediction Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if(runDiagnostic){
    ...
    predictionAnalysisListFile <- system.file("settings",
                                              ...
                                              package = "CovCoagFullGradientBoostingPrediction")
  ...
  if(createValidationPackage){
    ...
    if(!saveModelsToJson){
      ...
      tryCatch({
        ...
        createValidationPackageJson(devPackageName = 'CovCoagFullGradientBoostingPrediction',
                                    devDatabaseName = cdmDatabaseName,
                                    analysisLocation = outputFolder,
                                    analysisIds = analysesToValidate,
                                    outputFolder = outputFolder,
                                    packageName = 'CovCoagFullGradientBoostingPredictionValidation',
                                    description = 'validating models in CovCoagFullGradientBoostingPrediction',
                                    skeletonVersion = skeletonVersion,
                                    createdBy = 'anonymous',
