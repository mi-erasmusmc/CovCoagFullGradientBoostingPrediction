...
.createCohorts <- function(connection,
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "CovCoagFullGradientBoostingPrediction")
  ...
  if(!is.null(cohortVariableSetting)){
    ...
    pathToCustom <- system.file("settings", cohortVariableSetting, package = "CovCoagFullGradientBoostingPrediction")
